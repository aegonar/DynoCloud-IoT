...
//							overview.setUserID(rs_query_getLatest.getInt("UserID"));
  ...
  return Response.ok(jsonString, MediaType.APPLICATION_JSON).build();
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response getOverviewNode(@PathParam("EnclosureNodeID") int EnclosureNodeID) {
	  ...
	  ArrayList<Overview> OverviewList = new ArrayList<Overview>();
		...
		try{
			String query_getEnclosures = "SELECT * FROM EnclosureNode WHERE `EnclosureNodeID`=?;";// WHERE UserID=? AND CentralNodeID=?";
			prep_sql = link.linea.prepareStatement(query_getEnclosures);
