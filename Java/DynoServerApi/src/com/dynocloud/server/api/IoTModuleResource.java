...
//  
	...
	public Response postModule(Module module, @Context HttpHeaders headers) {
      ...
      System.out.println("["+currentUser.getUserName()+"] [POST] /IoT/module");
      
	  link.Open_link();
			
		try{
			String query_postModule = "INSERT INTO EnclosureNode (`CentralNodeID`,`UserID`,`Name`,`OPTIONAL_LOAD`,`PetProfileID`,`EnclosureNodeID`) VALUES (?,?,?,?,?,?);";
			...
			prep_sql.setInt(6, module.getEnclosureNodeID());
