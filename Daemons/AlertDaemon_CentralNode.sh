...
#Telemetry Daemon
export CLASSPATH="${CLASSPATH}:${install_dir}CentralNodeAlertDaemon/bin"

########################################################################################################################
echo "    _   _         _     ___                           "
echo "   /_\ | |___ _ _| |_  |   \ __ _ ___ _ __  ___ _ _   "
echo "  / _ \| / -_) '_|  _| | |) / _' / -_) '  \/ _ \ ' \  "
echo " /_/ \_\_\___|_|  \__| |___/\__,_\___|_|_|_\___/_||_| "
echo "                                                      "
echo --------------------------------------------------------------------------------------------------------
########################################################################################################################

#Telemetry Daemon
daemon="com.dynocloud.node.alert.Daemon"
